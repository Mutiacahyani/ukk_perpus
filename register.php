                                    ...
                                    <div class="card-body">
                                        <?php 
                                            if (isset($_POST['register'])) {
                                               ...
                                               if($insert){
                                                echo '<script>alert("Selamat, register berhasil. Selanjutnya silahkan Login"); location.href="login.php"</script>';
                                               }
                                               else{
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" required name="no_telpon" placeholder="Masukan No. Telepon">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputPassword" type="password" required name="password" placeholder="Masukan Password">
                                            </div>
                                            <div class="form-group">
